...
%
% This code might run into the some errors which are related to internet
% connection, "Could not access server. Host not found: www.bonds.is." or
...
for i = 1:length(IndexedBonds)
    ...
    % Adding the bond to the portfolio
    if i == 1 
